...
|**storageId** | **Integer** | ID S3-хранилища, которое будет источником контента. Нельзя передавать вместе с &#x60;server&#x60;. |  [optional] |
...
|**projectId** | **Integer** | ID проекта, в который нужно поместить ресурс. Если не указан, ресурс попадет в проект по умолчанию. |  [optional] |
|**trafficLimitBytes** | **Integer** | Лимит исходящего трафика на расчетный месяц, в байтах. При достижении лимита раздача останавливается автоматически. |  [optional] |
