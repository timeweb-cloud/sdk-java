...
|**filterAction** | [**FilterActionEnum**](#FilterActionEnum) | Действие фильтра спама |  [optional] |
|**filterStatus** | **Boolean** | Статус фильтра спама |  [optional] |
|**forwardList** | **List&lt;String&gt;** | Список адресов для пересылки |  [optional] |
...
|**whiteList** | **List&lt;String&gt;** | Белый список адресов |  [optional] |
