...
public class DomainsApi {
     ...
     * @param fqdn Полное имя домена или поддомена. (required)
     * @param recordId Идентификатор DNS-записи домена или поддомена. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param personId Идентификатор администратора, на которого зарегистрирован домен. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param tldId Идентификатор доменной зоны. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Получить информацию о доменной зоне по идентификатору (asynchronously)
     * Чтобы получить информацию о доменной зоне по идентификатору, отправьте запрос GET на &#x60;/api/v1/tlds/{tld_id}&#x60;.
     * @param tldId Идентификатор доменной зоны. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
