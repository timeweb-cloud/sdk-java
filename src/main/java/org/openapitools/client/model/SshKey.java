...
import org.openapitools.client.model.SshKeyUsedByInner;
...
public class SshKey {
  ...
  private List<SshKeyUsedByInner> usedBy = new ArrayList<>();
  ...
  public SshKey id(BigDecimal id) {
  ...
  **/
  ...
  public SshKey body(String body) {
  ...
  **/
  ...
  public SshKey usedBy(List<SshKeyUsedByInner> usedBy) {
    
    this.usedBy = usedBy;
    return this;
  }

  public SshKey addUsedByItem(SshKeyUsedByInner usedByItem) {
    if (this.usedBy == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<SshKeyUsedByInner> getUsedBy() {
    return usedBy;
  }


  public void setUsedBy(List<SshKeyUsedByInner> usedBy) {
    this.usedBy = usedBy;
  }


  public SshKey isDefault(Boolean isDefault) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, sshKey.id) &&
        ...
        Objects.equals(this.body, sshKey.body) &&
        Objects.equals(this.createdAt, sshKey.createdAt) &&
        Objects.equals(this.usedBy, sshKey.usedBy) &&
        Objects.equals(this.isDefault, sshKey.isDefault);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, body, createdAt, usedBy, isDefault);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayusedBy.size(); i++) {
        SshKeyUsedByInner.validateJsonElement(jsonArrayusedBy.get(i));
      };
  }
