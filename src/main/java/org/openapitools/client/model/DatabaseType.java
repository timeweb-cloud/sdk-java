...
public class DatabaseType {
  ...
  public DatabaseType name(String name) {
  ...
  **/
  ...
  public DatabaseType version(String version) {
  ...
  **/
  ...
  public DatabaseType type(String type) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : DatabaseType.openapiRequiredFields) {
