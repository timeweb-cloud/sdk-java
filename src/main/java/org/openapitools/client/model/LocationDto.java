...
public class LocationDto {
  ...
  public static final String SERIALIZED_NAME_AVAILABILITY_ZONES = "availability_zones";
  ...
  **/
  ...
  public LocationDto locationCode(String locationCode) {
  ...
  **/
  ...
  public LocationDto availabilityZones(List<String> availabilityZones) {
    
    this.availabilityZones = availabilityZones;
    return this;
  }

  public LocationDto addAvailabilityZonesItem(String availabilityZonesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.location, locationDto.location) &&
        Objects.equals(this.locationCode, locationDto.locationCode) &&
        Objects.equals(this.availabilityZones, locationDto.availabilityZones);
  }

  @Override
  public int hashCode() {
    return Objects.hash(location, locationCode, availabilityZones);
  }
  ...
  static {
    ...
    openapiFields.add("availability_zones");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("location");
    openapiRequiredFields.add("location_code");
    openapiRequiredFields.add("availability_zones");
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("location_code").isJsonPrimitive()) {
      ...
      if (jsonObj.get("availability_zones") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("availability_zones").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `availability_zones` to be an array in the JSON string but got `%s`", jsonObj.get("availability_zones").toString()));
      }
  }
