...
public class ConfigParameters {
  ...
  private ConfigParametersMysql mysql;
  ...
  public ConfigParameters mysql(ConfigParametersMysql mysql) {
  ...
  **/
  ...
  public ConfigParametersMysql getMysql() {
    return mysql;
  }


  public void setMysql(ConfigParametersMysql mysql) {
    this.mysql = mysql;
  }


  public ConfigParameters postgres(ConfigParametersPostgres postgres) {
  ...
  **/
  @javax.annotation.Nullable
  public ConfigParametersPostgres getPostgres() {
    return postgres;
  }


  public void setPostgres(ConfigParametersPostgres postgres) {
    this.postgres = postgres;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("mysql") != null && !jsonObj.get("mysql").isJsonNull()) {
        ConfigParametersMysql.validateJsonElement(jsonObj.get("mysql"));
      }
