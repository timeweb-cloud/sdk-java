...
public class GetDatabaseAutoBackupsSettings200Response {
  ...
  **/
  ...
  public GetDatabaseAutoBackupsSettings200Response responseId(UUID responseId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, getDatabaseAutoBackupsSettings200Response.meta) &&
        ...
        Objects.equals(this.responseId, getDatabaseAutoBackupsSettings200Response.responseId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, autoBackupsSettings, responseId);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetDatabaseAutoBackupsSettings200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatabaseAutoBackupsSettings200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatabaseAutoBackupsSettings200Response is not found in the empty JSON string", GetDatabaseAutoBackupsSettings200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetDatabaseAutoBackupsSettings200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatabaseAutoBackupsSettings200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetDatabaseAutoBackupsSettings200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatabaseAutoBackupsSettings200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatabaseAutoBackupsSettings200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatabaseAutoBackupsSettings200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatabaseAutoBackupsSettings200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatabaseAutoBackupsSettings200Response>() {
           @Override
           public void write(JsonWriter out, GetDatabaseAutoBackupsSettings200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatabaseAutoBackupsSettings200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetDatabaseAutoBackupsSettings200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetDatabaseAutoBackupsSettings200Response
  * @throws IOException if the JSON string is invalid with respect to GetDatabaseAutoBackupsSettings200Response
  */
  public static GetDatabaseAutoBackupsSettings200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatabaseAutoBackupsSettings200Response.class);
  }

 /**
  * Convert an instance of GetDatabaseAutoBackupsSettings200Response to an JSON string
  *
  * @return JSON string
  */
