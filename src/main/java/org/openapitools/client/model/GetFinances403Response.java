...
import org.openapitools.client.model.GetFinances403ResponseMessage;
...
public class GetFinances403Response {
  ...
  private GetFinances403ResponseMessage message;
  ...
  **/
  ...
  public GetFinances403Response message(GetFinances403ResponseMessage message) {
  ...
  **/
  ...
  public GetFinances403ResponseMessage getMessage() {
    return message;
  }


  public void setMessage(GetFinances403ResponseMessage message) {
    this.message = message;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("message") != null && !jsonObj.get("message").isJsonNull()) {
        GetFinances403ResponseMessage.validateJsonElement(jsonObj.get("message"));
      }
