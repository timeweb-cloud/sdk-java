...
import org.openapitools.client.model.ReplicaDisk;
...
public class Replica {
  ...
  private ReplicaDisk disk;

  public Replica() {
  }

  public Replica id(Integer id) {
  ...
  **/
  ...
  public Replica dbId(Integer dbId) {
  ...
  **/
  ...
  public Replica status(StatusEnum status) {
  ...
  **/
  ...
  public Replica localIp(String localIp) {
  ...
  **/
  ...
  public Replica disk(ReplicaDisk disk) {
  ...
  **/
  ...
  public ReplicaDisk getDisk() {
    return disk;
  }


  public void setDisk(ReplicaDisk disk) {
    this.disk = disk;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, replica.id) &&
        Objects.equals(this.dbId, replica.dbId) &&
        Objects.equals(this.status, replica.status) &&
        Objects.equals(this.localIp, replica.localIp) &&
        Objects.equals(this.disk, replica.disk);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Replica.openapiRequiredFields) {
      ...
      if (jsonObj.get("disk") != null && !jsonObj.get("disk").isJsonNull()) {
        ReplicaDisk.validateJsonElement(jsonObj.get("disk"));
      }
  }
