...
public class Preset {
  ...
  public static final String SERIALIZED_NAME_TRAFFIC_RATE_COST = "traffic_rate_cost";
  @SerializedName(SERIALIZED_NAME_TRAFFIC_RATE_COST)
  private BigDecimal trafficRateCost;

  public static final String SERIALIZED_NAME_REQUEST_RATE_COST = "request_rate_cost";
  @SerializedName(SERIALIZED_NAME_REQUEST_RATE_COST)
  private BigDecimal requestRateCost;
  ...
  public Preset id(Integer id) {
   ...
   /**
   * ID тарифа. Указывается в поле &#x60;preset_id&#x60; при создании и изменении ресурса.
   * @return id
  **/
  ...
  public Preset serviceName(String serviceName) {
  ...
  **/
  ...
  public Preset descriptionShort(String descriptionShort) {
  ...
  **/
  ...
  public Preset cost(BigDecimal cost) {
   ...
   /**
   * Абонентская плата за тариф в рублях.
   * @return cost
  **/
  @javax.annotation.Nonnull
  ...
  public Preset trafficRateCost(BigDecimal trafficRateCost) {
    
    this.trafficRateCost = trafficRateCost;
    return this;
  }

   /**
   * Стоимость единицы исходящего трафика по тарифу аккаунта, в рублях.
   * @return trafficRateCost
  **/
  @javax.annotation.Nonnull
  public BigDecimal getTrafficRateCost() {
    return trafficRateCost;
  }


  public void setTrafficRateCost(BigDecimal trafficRateCost) {
    this.trafficRateCost = trafficRateCost;
  }


  public Preset requestRateCost(BigDecimal requestRateCost) {
    
    this.requestRateCost = requestRateCost;
    return this;
  }

   /**
   * Стоимость единицы запросов по тарифу аккаунта, в рублях.
   * @return requestRateCost
  **/
  @javax.annotation.Nonnull
  public BigDecimal getRequestRateCost() {
    return requestRateCost;
  }


  public void setRequestRateCost(BigDecimal requestRateCost) {
    this.requestRateCost = requestRateCost;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, preset.id) &&
        Objects.equals(this.serviceName, preset.serviceName) &&
        Objects.equals(this.description, preset.description) &&
        Objects.equals(this.descriptionShort, preset.descriptionShort) &&
        Objects.equals(this.cost, preset.cost) &&
        Objects.equals(this.trafficRateCost, preset.trafficRateCost) &&
        Objects.equals(this.requestRateCost, preset.requestRateCost);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, serviceName, description, descriptionShort, cost, trafficRateCost, requestRateCost);
  }
  ...
  public String toString() {
    ...
    sb.append("    trafficRateCost: ").append(toIndentedString(trafficRateCost)).append("\n");
    sb.append("    requestRateCost: ").append(toIndentedString(requestRateCost)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("traffic_rate_cost");
    openapiFields.add("request_rate_cost");
    ...
    openapiRequiredFields.add("traffic_rate_cost");
    openapiRequiredFields.add("request_rate_cost");
  }
