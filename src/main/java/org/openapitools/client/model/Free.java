...
public class Free {
  ...
  public Free moneySource(MoneySourceEnum moneySource) {
  ...
  **/
  ...
  public Free personId(BigDecimal personId) {
  ...
  **/
  ...
  public Free authCode(String authCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Free free = (Free) o;
    return Objects.equals(this.moneySource, free.moneySource) &&
        Objects.equals(this.personId, free.personId) &&
        Objects.equals(this.authCode, free.authCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(moneySource, personId, authCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Free {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to Free
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Free.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Free is not found in the empty JSON string", Free.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Free.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Free` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Free.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Free.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Free' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Free> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Free.class));

       return (TypeAdapter<T>) new TypeAdapter<Free>() {
           @Override
           public void write(JsonWriter out, Free value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Free read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Free given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Free
  * @throws IOException if the JSON string is invalid with respect to Free
  */
  public static Free fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Free.class);
  }

 /**
  * Convert an instance of Free to an JSON string
  *
  * @return JSON string
  */
