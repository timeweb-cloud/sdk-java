...
public class CreateAdmin {
  ...
  public CreateAdmin login(String login) {
  ...
  **/
  ...
  public CreateAdmin password(String password) {
  ...
  **/
  ...
  public CreateAdmin host(String host) {
  ...
  **/
  ...
  public CreateAdmin description(String description) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateAdmin
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAdmin.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAdmin is not found in the empty JSON string", CreateAdmin.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateAdmin.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAdmin` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAdmin.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAdmin.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAdmin' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAdmin> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAdmin.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAdmin>() {
           @Override
           public void write(JsonWriter out, CreateAdmin value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAdmin read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateAdmin given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAdmin
  * @throws IOException if the JSON string is invalid with respect to CreateAdmin
  */
  public static CreateAdmin fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAdmin.class);
  }

 /**
  * Convert an instance of CreateAdmin to an JSON string
  *
  * @return JSON string
  */
