...
public class AddGithub {
  ...
  public AddGithub providerType(ProviderTypeEnum providerType) {
  ...
  **/
  ...
  public AddGithub providerToken(String providerToken) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddGithub addGithub = (AddGithub) o;
    return Objects.equals(this.providerType, addGithub.providerType) &&
        Objects.equals(this.providerToken, addGithub.providerToken);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AddGithub
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddGithub.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGithub is not found in the empty JSON string", AddGithub.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AddGithub.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddGithub` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGithub.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGithub.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGithub' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGithub> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGithub.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGithub>() {
           @Override
           public void write(JsonWriter out, AddGithub value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddGithub read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AddGithub given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGithub
  * @throws IOException if the JSON string is invalid with respect to AddGithub
  */
  public static AddGithub fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGithub.class);
  }

 /**
  * Convert an instance of AddGithub to an JSON string
  *
  * @return JSON string
  */
