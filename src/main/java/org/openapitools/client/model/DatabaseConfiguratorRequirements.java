...
public class DatabaseConfiguratorRequirements {
  ...
  public DatabaseConfiguratorRequirements() {
  }

  public DatabaseConfiguratorRequirements cpuMin(BigDecimal cpuMin) {
  ...
  **/
  ...
  public DatabaseConfiguratorRequirements cpuStep(BigDecimal cpuStep) {
  ...
  **/
  ...
  public DatabaseConfiguratorRequirements cpuMax(BigDecimal cpuMax) {
  ...
  **/
  ...
  public DatabaseConfiguratorRequirements ramMin(BigDecimal ramMin) {
   ...
   /**
   * Минимальный объём оперативной памяти (в Мб).
   * @return ramMin
  **/
  @javax.annotation.Nonnull
  ...
  public DatabaseConfiguratorRequirements ramStep(BigDecimal ramStep) {
   ...
   /**
   * Размер шага оперативной памяти (в Мб).
   * @return ramStep
  **/
  @javax.annotation.Nonnull
  ...
  public DatabaseConfiguratorRequirements ramMax(BigDecimal ramMax) {
   ...
   /**
   * Максимальный объём оперативной памяти (в Мб).
   * @return ramMax
  **/
  @javax.annotation.Nonnull
  ...
  public DatabaseConfiguratorRequirements diskMin(BigDecimal diskMin) {
  ...
  **/
  ...
  public DatabaseConfiguratorRequirements diskStep(BigDecimal diskStep) {
  ...
  **/
  ...
  public DatabaseConfiguratorRequirements diskMax(BigDecimal diskMax) {
  ...
  **/
  ...
  public DatabaseConfiguratorRequirements networkBandwidthMin(BigDecimal networkBandwidthMin) {
   ...
   /**
   * Минимальная пропускная способность интернет-канала (в Мбит/с).
  ...
  **/
  ...
  public DatabaseConfiguratorRequirements networkBandwidthStep(BigDecimal networkBandwidthStep) {
   ...
   /**
   * Размер шага пропускной способности интернет-канала (в Мбит/с).
  ...
  **/
  ...
  public DatabaseConfiguratorRequirements networkBandwidthMax(BigDecimal networkBandwidthMax) {
   ...
   /**
   * Максимальная пропускная способность интернет-канала (в Мбит/с).
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DatabaseConfiguratorRequirements databaseConfiguratorRequirements = (DatabaseConfiguratorRequirements) o;
    return Objects.equals(this.cpuMin, databaseConfiguratorRequirements.cpuMin) &&
        Objects.equals(this.cpuStep, databaseConfiguratorRequirements.cpuStep) &&
        Objects.equals(this.cpuMax, databaseConfiguratorRequirements.cpuMax) &&
        Objects.equals(this.ramMin, databaseConfiguratorRequirements.ramMin) &&
        Objects.equals(this.ramStep, databaseConfiguratorRequirements.ramStep) &&
        Objects.equals(this.ramMax, databaseConfiguratorRequirements.ramMax) &&
        Objects.equals(this.diskMin, databaseConfiguratorRequirements.diskMin) &&
        Objects.equals(this.diskStep, databaseConfiguratorRequirements.diskStep) &&
        Objects.equals(this.diskMax, databaseConfiguratorRequirements.diskMax) &&
        Objects.equals(this.networkBandwidthMin, databaseConfiguratorRequirements.networkBandwidthMin) &&
        Objects.equals(this.networkBandwidthStep, databaseConfiguratorRequirements.networkBandwidthStep) &&
        Objects.equals(this.networkBandwidthMax, databaseConfiguratorRequirements.networkBandwidthMax);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseConfiguratorRequirements {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DatabaseConfiguratorRequirements
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseConfiguratorRequirements.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseConfiguratorRequirements is not found in the empty JSON string", DatabaseConfiguratorRequirements.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DatabaseConfiguratorRequirements.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseConfiguratorRequirements` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabaseConfiguratorRequirements.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseConfiguratorRequirements.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseConfiguratorRequirements' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseConfiguratorRequirements> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseConfiguratorRequirements.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseConfiguratorRequirements>() {
           @Override
           public void write(JsonWriter out, DatabaseConfiguratorRequirements value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseConfiguratorRequirements read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DatabaseConfiguratorRequirements given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseConfiguratorRequirements
  * @throws IOException if the JSON string is invalid with respect to DatabaseConfiguratorRequirements
  */
  public static DatabaseConfiguratorRequirements fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseConfiguratorRequirements.class);
  }

 /**
  * Convert an instance of DatabaseConfiguratorRequirements to an JSON string
  *
  * @return JSON string
  */
