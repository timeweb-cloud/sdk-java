 ...
 */
@JsonAdapter(NotificationSettingType.Adapter.class)
public enum NotificationSettingType {
  ...
  public static NotificationSettingType fromValue(String value) {
    for (NotificationSettingType b : NotificationSettingType.values()) {
  ...
  public static class Adapter extends TypeAdapter<NotificationSettingType> {
    @Override
    public void write(final JsonWriter jsonWriter, final NotificationSettingType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NotificationSettingType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NotificationSettingType.fromValue(value);
    }
  }
}
