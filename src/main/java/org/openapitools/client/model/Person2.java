...
public class Person2 {
  ...
  public Person2 type(TypeEnum type) {
  ...
  **/
  ...
  public Person2 name(String name) {
  ...
  **/
  ...
  public Person2 isResident(Boolean isResident) {
  ...
  **/
  ...
  public Person2 birthdate(String birthdate) {
  ...
  **/
  ...
  public Person2 passportDate(String passportDate) {
  ...
  **/
  ...
  public Person2 passportNumber(String passportNumber) {
  ...
  **/
  ...
  public Person2 passportPlace(String passportPlace) {
  ...
  **/
  ...
  public Person2 passportSeries(String passportSeries) {
  ...
  **/
  ...
  public Person2 postcode(String postcode) {
  ...
  **/
  ...
  public Person2 mailingAddress(String mailingAddress) {
  ...
  **/
  ...
  public Person2 phone(String phone) {
  ...
  **/
  ...
  public Person2 email(String email) {
  ...
  **/
  ...
  public Person2 countryCode(String countryCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, person2.type) &&
        Objects.equals(this.name, person2.name) &&
        Objects.equals(this.isResident, person2.isResident) &&
        Objects.equals(this.birthdate, person2.birthdate) &&
        Objects.equals(this.passportDate, person2.passportDate) &&
        Objects.equals(this.passportNumber, person2.passportNumber) &&
        Objects.equals(this.passportPlace, person2.passportPlace) &&
        Objects.equals(this.passportSeries, person2.passportSeries) &&
        Objects.equals(this.postcode, person2.postcode) &&
        Objects.equals(this.mailingAddress, person2.mailingAddress) &&
        Objects.equals(this.phone, person2.phone) &&
        Objects.equals(this.email, person2.email) &&
        Objects.equals(this.countryCode, person2.countryCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, isResident, birthdate, passportDate, passportNumber, passportPlace, passportSeries, postcode, mailingAddress, phone, email, countryCode);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to Person2
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Person2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Person2 is not found in the empty JSON string", Person2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Person2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Person2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Person2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Person2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Person2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Person2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Person2.class));

       return (TypeAdapter<T>) new TypeAdapter<Person2>() {
           @Override
           public void write(JsonWriter out, Person2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Person2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Person2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Person2
  * @throws IOException if the JSON string is invalid with respect to Person2
  */
  public static Person2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Person2.class);
  }

 /**
  * Convert an instance of Person2 to an JSON string
  *
  * @return JSON string
  */
