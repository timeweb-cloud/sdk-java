...
public class ModelV3 {
  ...
  public static final String SERIALIZED_NAME_PARAMS_INFO = "params_info";
  @SerializedName(SERIALIZED_NAME_PARAMS_INFO)
  ...
  public ModelV3 id(BigDecimal id) {
  ...
  **/
  ...
  public ModelV3 providerId(BigDecimal providerId) {
  ...
  **/
  ...
  public ModelV3 name(String name) {
  ...
  **/
  ...
  public ModelV3 publicName(String publicName) {
  ...
  **/
  ...
  public ModelV3 modelName(String modelName) {
  ...
  **/
  ...
  public ModelV3 type(TypeEnum type) {
  ...
  **/
  ...
  public ModelV3 version(String version) {
  ...
  **/
  ...
  public ModelV3 isDeprecated(Boolean isDeprecated) {
  ...
  **/
  ...
  public ModelV3 isStopped(Boolean isStopped) {
  ...
  **/
  ...
  public ModelV3 deprecationDate(OffsetDateTime deprecationDate) {
  ...
  **/
  ...
  public ModelV3 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ModelV3 updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ModelV3 paramsInfo(Object paramsInfo) {
  ...
  **/
  ...
  public ModelV3 parameterValues(Map<String, Object> parameterValues) {
    
    this.parameterValues = parameterValues;
    return this;
  }

  public ModelV3 putParameterValuesItem(String key, Object parameterValuesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelV3 modelV3 = (ModelV3) o;
    return Objects.equals(this.id, modelV3.id) &&
        Objects.equals(this.providerId, modelV3.providerId) &&
        Objects.equals(this.name, modelV3.name) &&
        Objects.equals(this.publicName, modelV3.publicName) &&
        Objects.equals(this.modelName, modelV3.modelName) &&
        Objects.equals(this.type, modelV3.type) &&
        Objects.equals(this.version, modelV3.version) &&
        Objects.equals(this.isDeprecated, modelV3.isDeprecated) &&
        Objects.equals(this.isStopped, modelV3.isStopped) &&
        Objects.equals(this.deprecationDate, modelV3.deprecationDate) &&
        Objects.equals(this.createdAt, modelV3.createdAt) &&
        Objects.equals(this.updatedAt, modelV3.updatedAt) &&
        Objects.equals(this.paramsInfo, modelV3.paramsInfo) &&
        Objects.equals(this.parameterValues, modelV3.parameterValues);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, providerId, name, publicName, modelName, type, version, isDeprecated, isStopped, deprecationDate, createdAt, updatedAt, paramsInfo, parameterValues);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("parameter_values");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ModelV3
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelV3 is not found in the empty JSON string", ModelV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ModelV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ModelV3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelV3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelV3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelV3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelV3.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelV3>() {
           @Override
           public void write(JsonWriter out, ModelV3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelV3 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ModelV3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ModelV3
  * @throws IOException if the JSON string is invalid with respect to ModelV3
  */
  public static ModelV3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelV3.class);
  }

 /**
  * Convert an instance of ModelV3 to an JSON string
  *
  * @return JSON string
  */
