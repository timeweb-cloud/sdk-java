...
public class Bonus {
  ...
  public Bonus moneySource(MoneySourceEnum moneySource) {
  ...
  **/
  ...
  public Bonus personId(BigDecimal personId) {
  ...
  **/
  ...
  public Bonus bonusId(BigDecimal bonusId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Bonus bonus = (Bonus) o;
    return Objects.equals(this.moneySource, bonus.moneySource) &&
        Objects.equals(this.personId, bonus.personId) &&
        Objects.equals(this.bonusId, bonus.bonusId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(moneySource, personId, bonusId);
  }
  ...
  static {
    ...
    openapiFields.add("bonus_id");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("money_source");
    openapiRequiredFields.add("bonus_id");
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Bonus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Bonus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Bonus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Bonus.openapiRequiredFields) {
