...
public class Certificate {
  ...
  /**
   * Тип сертификата. - &#x60;lets_encrypt&#x60; — сертификат, выпущенный через Let&#39;s Encrypt; - &#x60;uploaded&#x60; — сертификат, загруженный вами.
   */
  ...
  public Certificate id(Integer id) {
   ...
   /**
   * ID сертификата. Указывается в поле &#x60;config.security.certificate_id&#x60; при привязке сертификата к ресурсу.
   * @return id
  **/
  ...
  **/
  ...
  public Certificate cn(String cn) {
   ...
   /**
   * Основное доменное имя сертификата.
   * @return cn
  **/
  @javax.annotation.Nonnull
  public String getCn() {
  ...
  public Certificate domains(List<String> domains) {
    
    this.domains = domains;
    return this;
  }

  public Certificate addDomainsItem(String domainsItem) {
   ...
   /**
   * Все доменные имена сертификата, включая указанные в SAN.
   * @return domains
  **/
  @javax.annotation.Nonnull
  ...
  **/
  ...
  public Certificate expiresAt(OffsetDateTime expiresAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, certificate.id) &&
        ...
        Objects.equals(this.cn, certificate.cn) &&
        Objects.equals(this.domains, certificate.domains) &&
        Objects.equals(this.issuedAt, certificate.issuedAt) &&
        Objects.equals(this.expiresAt, certificate.expiresAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, cn, domains, issuedAt, expiresAt);
  }
