...
public class DatabaseInstance {
  ...
  public DatabaseInstance id(BigDecimal id) {
  ...
  **/
  ...
  public DatabaseInstance createdAt(String createdAt) {
  ...
  **/
  ...
  public DatabaseInstance description(String description) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : DatabaseInstance.openapiRequiredFields) {
