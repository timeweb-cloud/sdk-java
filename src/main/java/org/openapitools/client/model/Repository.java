...
public class Repository {
  ...
  public static final String SERIALIZED_NAME_IS_ALLOWED_WEBHOOK = "is_allowed_webhook";
  @SerializedName(SERIALIZED_NAME_IS_ALLOWED_WEBHOOK)
  private Boolean isAllowedWebhook;

  public Repository() {
  }

  public Repository id(UUID id) {
  ...
  **/
  ...
  public Repository isAllowedWebhook(Boolean isAllowedWebhook) {
   ...
   * @return isAllowedWebhook
  **/
  @javax.annotation.Nonnull
  public Boolean getIsAllowedWebhook() {
    return isAllowedWebhook;
  }


  public void setIsAllowedWebhook(Boolean isAllowedWebhook) {
    this.isAllowedWebhook = isAllowedWebhook;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, repository.id) &&
        ...
        Objects.equals(this.isAllowedWebhook, repository.isAllowedWebhook);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, fullName, url, isPrivate, isAllowedWebhook);
  }
  ...
  public String toString() {
    ...
    sb.append("    isAllowedWebhook: ").append(toIndentedString(isAllowedWebhook)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("is_allowed_webhook");
    ...
    openapiRequiredFields.add("is_allowed_webhook");
  }
