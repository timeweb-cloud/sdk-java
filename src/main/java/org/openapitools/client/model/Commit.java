...
public class Commit {
  ...
  **/
  ...
  public Commit createdAt(OffsetDateTime createdAt) {
   ...
   /**
   * Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан коммит.
   * @return createdAt
  **/
  @javax.annotation.Nonnull
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sha, commit.sha) &&
        Objects.equals(this.createdAt, commit.createdAt) &&
        Objects.equals(this.message, commit.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sha, createdAt, message);
  }
