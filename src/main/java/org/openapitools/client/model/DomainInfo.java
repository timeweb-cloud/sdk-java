...
public class DomainInfo {
  ...
  public DomainInfo email(String email) {
  ...
  **/
  ...
  public DomainInfo used(BigDecimal used) {
   ...
   /**
   * Использованное место на почте (в Мб).
   * @return used
  **/
  @javax.annotation.Nonnull
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, domainInfo.email) &&
        Objects.equals(this.used, domainInfo.used);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, used);
  }
