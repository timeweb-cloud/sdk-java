...
public class UpdateKeyRequest {
  ...
  public UpdateKeyRequest body(String body) {
  ...
  **/
  ...
  public UpdateKeyRequest isDefault(Boolean isDefault) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.body, updateKeyRequest.body) &&
        Objects.equals(this.isDefault, updateKeyRequest.isDefault) &&
        Objects.equals(this.name, updateKeyRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(body, isDefault, name);
  }
