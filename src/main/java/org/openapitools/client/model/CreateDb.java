...
public class CreateDb {
  ...
  public CreateDb login(String login) {
  ...
  **/
  ...
  public CreateDb password(String password) {
  ...
  **/
  ...
  public CreateDb name(String name) {
  ...
  **/
  ...
  public CreateDb type(DbType type) {
  ...
  **/
  ...
  public CreateDb hashType(HashTypeEnum hashType) {
  ...
  **/
  ...
  public CreateDb presetId(Integer presetId) {
  ...
  **/
  ...
  public CreateDb configParameters(ConfigParameters configParameters) {
  ...
  **/
  ...
  public CreateDb network(Network network) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.login, createDb.login) &&
        Objects.equals(this.password, createDb.password) &&
        Objects.equals(this.name, createDb.name) &&
        Objects.equals(this.type, createDb.type) &&
        Objects.equals(this.hashType, createDb.hashType) &&
        Objects.equals(this.presetId, createDb.presetId) &&
        Objects.equals(this.configParameters, createDb.configParameters) &&
        Objects.equals(this.network, createDb.network);
  }

  @Override
  public int hashCode() {
    return Objects.hash(login, password, name, type, hashType, presetId, configParameters, network);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateDb {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateDb
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDb is not found in the empty JSON string", CreateDb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateDb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDb.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDb.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDb>() {
           @Override
           public void write(JsonWriter out, CreateDb value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDb read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateDb given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateDb
  * @throws IOException if the JSON string is invalid with respect to CreateDb
  */
  public static CreateDb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDb.class);
  }

 /**
  * Convert an instance of CreateDb to an JSON string
  *
  * @return JSON string
  */
