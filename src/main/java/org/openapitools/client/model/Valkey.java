...
public class Valkey {
  ...
  public Valkey clientOutputBufferLimitNormal(String clientOutputBufferLimitNormal) {
  ...
  **/
  ...
  public Valkey clientOutputBufferLimitPubsub(String clientOutputBufferLimitPubsub) {
  ...
  **/
  ...
  public Valkey databases(String databases) {
  ...
  **/
  ...
  public Valkey timeout(String timeout) {
  ...
  **/
  ...
  public Valkey maxmemoryPolicy(String maxmemoryPolicy) {
  ...
  **/
  ...
  public Valkey slowlogLogSlowerThan(String slowlogLogSlowerThan) {
  ...
  **/
  ...
  public Valkey slowlogMaxLen(String slowlogMaxLen) {
  ...
  **/
  ...
  public Valkey save(String save) {
  ...
  **/
  ...
  public Valkey appendonly(String appendonly) {
  ...
  **/
  ...
  public Valkey appendfsync(String appendfsync) {
  ...
  **/
  ...
  public Valkey tcpKeepalive(String tcpKeepalive) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientOutputBufferLimitNormal, valkey.clientOutputBufferLimitNormal) &&
        ...
        Objects.equals(this.maxmemoryPolicy, valkey.maxmemoryPolicy) &&
        Objects.equals(this.slowlogLogSlowerThan, valkey.slowlogLogSlowerThan) &&
        Objects.equals(this.slowlogMaxLen, valkey.slowlogMaxLen) &&
        Objects.equals(this.save, valkey.save) &&
        Objects.equals(this.appendonly, valkey.appendonly) &&
        Objects.equals(this.appendfsync, valkey.appendfsync) &&
        Objects.equals(this.tcpKeepalive, valkey.tcpKeepalive);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to Valkey
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Valkey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Valkey is not found in the empty JSON string", Valkey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Valkey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Valkey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Valkey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Valkey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Valkey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Valkey.class));

       return (TypeAdapter<T>) new TypeAdapter<Valkey>() {
           @Override
           public void write(JsonWriter out, Valkey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Valkey read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Valkey given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Valkey
  * @throws IOException if the JSON string is invalid with respect to Valkey
  */
  public static Valkey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Valkey.class);
  }

 /**
  * Convert an instance of Valkey to an JSON string
  *
  * @return JSON string
  */
