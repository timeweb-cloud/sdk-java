...
/**
 * Расширение базы данных. Для кластеров PostgreSQL доступны расширения PostgreSQL, для кластеров RabbitMQ — плагины RabbitMQ. Если расширение не подходит типу кластера, вернется ошибка &#x60;invalid_extension&#x60;.
 */
@JsonAdapter(DbExtension.Adapter.class)
public enum DbExtension {
  ...
  RABBITMQ_FEDERATION("rabbitmq_federation"),
  
  RABBITMQ_FEDERATION_MANAGEMENT("rabbitmq_federation_management"),
  
  RABBITMQ_FEDERATION_PROMETHEUS("rabbitmq_federation_prometheus"),
  
  RABBITMQ_JMS_TOPIC_EXCHANGE("rabbitmq_jms_topic_exchange"),
  ...
  RABBITMQ_PEER_DISCOVERY_CONSUL("rabbitmq_peer_discovery_consul"),
  
  RABBITMQ_PEER_DISCOVERY_ETCD("rabbitmq_peer_discovery_etcd"),
  
  RABBITMQ_PEER_DISCOVERY_K8S("rabbitmq_peer_discovery_k8s"),
  
  RABBITMQ_PROMETHEUS("rabbitmq_prometheus"),
  
  RABBITMQ_RANDOM_EXCHANGE("rabbitmq_random_exchange"),
  ...
  RABBITMQ_STREAM("rabbitmq_stream"),
  ...
  RABBITMQ_WEB_MQTT("rabbitmq_web_mqtt"),
  
  RABBITMQ_WEB_STOMP("rabbitmq_web_stomp");

  private String value;

  DbExtension(String value) {
    this.value = value;
  }
  ...
  public static DbExtension fromValue(String value) {
    for (DbExtension b : DbExtension.values()) {
  ...
  public static class Adapter extends TypeAdapter<DbExtension> {
    @Override
    public void write(final JsonWriter jsonWriter, final DbExtension enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DbExtension read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DbExtension.fromValue(value);
    }
  }
}
