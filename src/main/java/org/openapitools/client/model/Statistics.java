...
import org.openapitools.client.model.StatisticsRequestsInner;
import org.openapitools.client.model.StatisticsTrafficInner;
...
public class Statistics {
  ...
  private List<StatisticsTrafficInner> traffic = new ArrayList<>();

  public static final String SERIALIZED_NAME_REQUESTS = "requests";
  @SerializedName(SERIALIZED_NAME_REQUESTS)
  private List<StatisticsRequestsInner> requests = new ArrayList<>();

  public Statistics() {
  }

  public Statistics traffic(List<StatisticsTrafficInner> traffic) {
    
    this.traffic = traffic;
    return this;
  }

  public Statistics addTrafficItem(StatisticsTrafficInner trafficItem) {
  ...
  **/
  ...
  public List<StatisticsTrafficInner> getTraffic() {
    return traffic;
  }


  public void setTraffic(List<StatisticsTrafficInner> traffic) {
    this.traffic = traffic;
  }


  public Statistics requests(List<StatisticsRequestsInner> requests) {
    
    this.requests = requests;
    return this;
  }

  public Statistics addRequestsItem(StatisticsRequestsInner requestsItem) {
   ...
   /**
   * Количество запросов по часовым интервалам с разбивкой по классам HTTP-статуса ответа.
   * @return requests
  **/
  @javax.annotation.Nonnull
  public List<StatisticsRequestsInner> getRequests() {
    return requests;
  }


  public void setRequests(List<StatisticsRequestsInner> requests) {
    this.requests = requests;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.traffic, statistics.traffic) &&
        Objects.equals(this.requests, statistics.requests);
  }

  @Override
  public int hashCode() {
    return Objects.hash(traffic, requests);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `traffic` (array)
      for (int i = 0; i < jsonArraytraffic.size(); i++) {
        StatisticsTrafficInner.validateJsonElement(jsonArraytraffic.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayrequests.size(); i++) {
        StatisticsRequestsInner.validateJsonElement(jsonArrayrequests.get(i));
      };
  }
