...
import org.openapitools.client.model.GetFinances404ResponseMessage;
...
public class GetFinances404Response {
  ...
  private GetFinances404ResponseMessage message;
  ...
  **/
  ...
  public GetFinances404Response message(GetFinances404ResponseMessage message) {
  ...
  **/
  ...
  public GetFinances404ResponseMessage getMessage() {
    return message;
  }


  public void setMessage(GetFinances404ResponseMessage message) {
    this.message = message;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("message") != null && !jsonObj.get("message").isJsonNull()) {
        GetFinances404ResponseMessage.validateJsonElement(jsonObj.get("message"));
      }
