...
public class GetTokens200Response {
  ...
  public GetTokens200Response meta(Meta meta) {
  ...
  **/
  ...
  public GetTokens200Response apiKeys(List<ApiKey> apiKeys) {
    
    this.apiKeys = apiKeys;
    return this;
  }

  public GetTokens200Response addApiKeysItem(ApiKey apiKeysItem) {
  ...
  **/
  ...
  public GetTokens200Response responseId(UUID responseId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, getTokens200Response.meta) &&
        Objects.equals(this.apiKeys, getTokens200Response.apiKeys) &&
        Objects.equals(this.responseId, getTokens200Response.responseId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, apiKeys, responseId);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetTokens200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTokens200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetTokens200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTokens200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTokens200Response.openapiRequiredFields) {
      ...
      // validate the required field `api_keys` (array)
