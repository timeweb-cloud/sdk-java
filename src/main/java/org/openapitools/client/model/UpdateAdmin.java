...
public class UpdateAdmin {
  ...
  **/
  ...
  public UpdateAdmin privileges(List<PrivilegesEnum> privileges) {
    
    this.privileges = privileges;
    return this;
  }

  public UpdateAdmin addPrivilegesItem(PrivilegesEnum privilegesItem) {
  ...
  **/
  ...
  public UpdateAdmin description(String description) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateAdmin
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAdmin.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAdmin is not found in the empty JSON string", UpdateAdmin.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateAdmin.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAdmin` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAdmin.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAdmin' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAdmin> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAdmin.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAdmin>() {
           @Override
           public void write(JsonWriter out, UpdateAdmin value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAdmin read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpdateAdmin given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateAdmin
  * @throws IOException if the JSON string is invalid with respect to UpdateAdmin
  */
  public static UpdateAdmin fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAdmin.class);
  }

 /**
  * Convert an instance of UpdateAdmin to an JSON string
  *
  * @return JSON string
  */
